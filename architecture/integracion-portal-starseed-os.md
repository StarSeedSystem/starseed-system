...
27/27 escenarios: X por clic y por toque en las tres cortinas (disco ≥44 px en táctil), botones internos, Escape, clic/toque fuera, arrastre con ratón y con dedo, latigazo, arrastre corto que vuelve, scroll vertical intacto en Horizon y en el chat, rueda de trackpad, y apertura desde el borde siguiendo al dedo y al ratón (fondo a medio oscurecer a mitad de gesto). Pruebas de componente y del motor en `src/**/__tests__`.
