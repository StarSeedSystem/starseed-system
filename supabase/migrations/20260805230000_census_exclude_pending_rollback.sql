-- ROLLBACK de 20260805230000_census_exclude_pending.sql (Adenda 149).
-- Restaura gov_scope_member_ids + gov_resolve_proposal a la version de la Adenda
-- 146 (SIN el filtro role<>'pending'). Solo emergencia. Aplicar via Management API.
