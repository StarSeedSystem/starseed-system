...
> Generado por `scripts/puente/sincronizar-ides.py` el 2026-09-22 11:10:34 desde el Mando vivo.
...
| HEAD | `7ef4d1dd chore(memoria): aprendizaje de la ola auto-0922-105100` |
| Sin publicar | 10 commits |
| Árbol | limpio |

## Quién escribe ahora (latido de `cola-auto-0922-105100.json`, hace 5s)

| tarea | fase | modelo | lleva | quieto | bytes |
|---|---|---|---|---|---|
| `DR0922-1` | hecho | apinex/free/muse-spark-1.3 | 0 min | 30 s | 29871 |
| `TK2c` | hecho | google/gemini-3.6-flash | 10 min | 618 s | 642082 |
| `AGR2c` | hecho | google/gemini-3.6-flash | 11 min | 680 s | 988423 |
| `c313_QW6` | hecho | apinex/free/gemini-3.8-flash | 13 min | 787 s | 453273 |
| `RM4` | hecho | google/gemini-3.6-flash | 13 min | 789 s | 673845 |
| `c313_QW4` | hecho | apinex/free/gemini-3.8-flash | 15 min | 895 s | 460038 |
| `RM3` | hecho | google/gemini-3.6-flash | 15 min | 905 s | 874951 |
| `TK1c` | hecho | google/gemini-3.6-flash | 16 min | 990 s | 1087120 |
