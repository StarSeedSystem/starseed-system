...
> Generado por `scripts/puente/sincronizar-ides.py` el 2026-09-20 11:04:23 desde el Mando vivo.
...
| HEAD | `597a26f7 chore(memoria): aprendizaje de la ola auto-0920-105938` |
| Sin publicar | 100 commits |
| Árbol | limpio |

## Quién escribe ahora (latido de `cola-auto-0920-105938.json`, hace 5s)

| tarea | fase | modelo | lleva | quieto | bytes |
|---|---|---|---|---|---|
| `MD1b` | hecho | nvidia/moonshotai/kimi-k3 | 3 min | 167 s | 653839 |
