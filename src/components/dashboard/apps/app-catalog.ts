...
export const APP_CATALOG: StarseedApp[] = [
    ...
    },
    {
        ...
        icon: Waves,
        iconUrl: "/app-icons/omnifrecuencias.svg",
        accent: "#22D3EE",
        category: "starseed",
        status: "native",
        open: {
    ...
    // ── Módulos nativos del sistema ──────────────────────────────
    {
        ...
        icon: MessageSquare,
        iconUrl: "/app-icons/messages.svg",
        accent: "#007FFF",
        category: "sistema",
        status: "native",
