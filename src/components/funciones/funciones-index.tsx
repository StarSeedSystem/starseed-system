...
import {
  ...
  Mail,
  Bell,
  // Ola 6 · Adenda 158 — las 21 áreas del sistema original Astraura 1.58-bit.
  Headphones,
  FolderTree,
  Users,
  GitBranch,
...
const GROUPS: FeatureGroup[] = [
  {
    id: "ia-studio",
    title: "Astraura AI & Orchestration",
    description: "Las 21 áreas del sistema soberano 1.58-bit: imaginación, enjambre, cerebros, memoria, sensorium, bóveda y todo lo demás.",
    icon: Sparkles,
    accent: "fuchsia",
    // Ola 6 · Adenda 158: este índice se reescribe para seguir al menú nuevo.
    // Es la CUARTA fuente de verdad de la navegación (junto a STUDIO_SECTIONS,
    // dock-config y app-catalog) y no se sincroniza sola: si el menú cambia,
    // hay que tocarla a mano. De paso se corrige el error histórico de la
    // primera fila, etiquetada «Nexus» pero apuntando a Chats.
    features: [
      { label: "Chat multiagéntico", route: "/agent?tab=chat", blurb: "Conversa con Astraura en tiempo real — el mismo hilo que el orbe.", icon: MessageSquare },
      { label: "VoiceStudio", route: "/agent?tab=aurora", blurb: "La voz de cada personalidad: estudio, coherencia y OmniVoice.", icon: Headphones },
      { label: "Proyectos y creaciones", route: "/agent?tab=proyectos-158", blurb: "La bóveda Daedalus 1.58b: proyectos, versiones, ramas y creaciones.", icon: FolderTree },
      { label: "Imaginación Intuitiva", route: "/imaginacion", blurb: "Always-On: procesos oníricos, troncos de recursos, ramas y propuestas.", icon: Sparkles },
      { label: "Almacenamiento y medios", route: "/agent?tab=almacenamiento-158", blurb: "Reglas de enrutado, unidades y fusión de cerebros externos.", icon: HardDrive },
      { label: "Sensorium 360°", route: "/agent?tab=sensorium", blurb: "Sensores del entorno, ubicación y clima de la neurona.", icon: Activity },
      { label: "Privacidad y sensores", route: "/agent?tab=privacidad", blurb: "Permisos reales del navegador, air-gap y privacidad soberana.", icon: ShieldCheck },
      { label: "Notificaciones y logs", route: "/agent?tab=notificaciones", blurb: "Autorizaciones pendientes, auto-mejoras y eventos del ecosistema.", icon: Bell },
      { label: "Cerebros", route: "/agent?tab=cerebros", blurb: "Cerebros multidimensionales, sus servidores y su red viva.", icon: Cpu },
      { label: "Memorias y recuerdos", route: "/agent?tab=memorias", blurb: "Grafo sináptico, recuerdos fijados, documentos y OpenViking.", icon: Archive },
      { label: "Personalidades", route: "/agent?tab=personalidades", blurb: "Los arquetipos de Astraura: identidad, voz, memoria y malla.", icon: Sun },
      { label: "Enjambre de agentes", route: "/agent?tab=enjambre", blurb: "Quién trabaja ahora en segundo plano y bajo qué director.", icon: Users },
      { label: "Navegador autónomo", route: "/agent?tab=navegador-158", blurb: "La IA navegando sola: búsqueda, lectura saneada y acciones web.", icon: Globe },
      { label: "Explorador del dispositivo", route: "/agent?tab=explorador", blurb: "Archivos de la neurona, unidades e indexado en memoria 1.58.", icon: FolderTree },
      { label: "Workflows", route: "/agent?tab=workflows-158", blurb: "Automatizaciones que se disparan solas, con su ciclo completo.", icon: GitBranch },
      { label: "Bóveda soberana", route: "/agent?tab=boveda", blurb: "Credenciales de servicios y parámetros de inferencia del motor.", icon: Key },
      { label: "Instalador y scan", route: "/agent?tab=instalador", blurb: "Instala la neurona en cualquier sistema y descubre dispositivos.", icon: Box },
      { label: "Biblioteca StarSeed", route: "/agent?tab=biblioteca", blurb: "El catálogo instalable de habilidades y apps del ecosistema.", icon: Layers },
      { label: "Telemetría 1.58-bit", route: "/agent?tab=telemetria", blurb: "Qué motor corre de verdad, a qué velocidad y con cuánta memoria.", icon: Gauge },
      { label: "Terminal y sandbox", route: "/agent?tab=terminal", blurb: "Consola de la neurona y sandbox aislado del navegador.", icon: TerminalSquare },
      { label: "Configuración", route: "/agent?tab=config-ia", blurb: "Sistema primario, proveedores, neuronas y preferencias soberanas.", icon: Sliders },
      // Áreas del OS que viven dentro de esas 21 secciones.
      { label: "Cerebro 3D", route: "/agent?tab=cerebro", blurb: "El núcleo cognitivo, visualizado en el espacio.", icon: Brain },
      { label: "Agent Foundry", route: "/agent?tab=foundry", blurb: "Forja y entrena nuevos agentes.", icon: Hammer },
      ...
      { label: "Sentidos", route: "/agent?tab=sentidos", blurb: "Canales de percepción multimodal del agente.", icon: Eye },
      ...
      { label: "Agentes (runtimes)", route: "/agent?tab=agentes", blurb: "Dónde corren tus agentes: dispositivo, multi-neurona o VPS.", icon: Bot },
      ...
      { label: "Decisiones", route: "/agent?tab=decisiones", blurb: "Gobernanza de la red y propuestas en curso.", icon: Vote },
      { label: "Mi actividad", route: "/agent?tab=mi-actividad", blurb: "Tu historial democrático.", icon: Activity },
      ...
      { label: "Habilidades", route: "/agent?tab=habilidades", blurb: "Capacidades vinculables del agente.", icon: Zap },
