...
interface ExternalCalendar {
  ...
  color: string;
  authKind: 'oauth' | 'caldav' | 'ics-url' | 'app-password';
  enabled: boolean;
  account?: string;
  url?: string;
  lastSync?: string;
...
export function ExternalCalendarConnectors() {
  ...
  const sync = (c: ExternalCalendar) => {
    // Mock: en producción dispararíamos un fetch a /api/calendars/{id}/sync
        ...
        <div className="flex items-baseline justify-between flex-wrap gap-2">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">
              Sincroniza Google, Apple, Outlook, Proton, Nextcloud o cualquier CalDAV/.ics.
              Cada conector activo se refleja también como nodo en tu Cerebro.
            </p>
          </div>
