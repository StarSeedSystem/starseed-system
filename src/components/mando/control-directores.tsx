...
/**
 * 🎛️ Control de Directores · Panel de orquestación multiagentica
 * 
 * Muestra información detallada de los agentes orquestadores activos:
    ...
    if (cargando && !estado) {
        return (
            <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/30 p-4 text-sm text-white/60">
                ...
                Cargando control de directores...
            </div>
        );
    }
