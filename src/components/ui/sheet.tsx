  ...
  return (
    <SheetPortal>
      ...
      >
        ...
        {/* X común del OS en la esquina que mira al centro: en un panel lateral
            queda a mano y lejos del gesto «atrás» del sistema. */}
        <SheetPrimitive.Close asChild>
          <BotonCerrar
            etiqueta="Cerrar"
            atajo="Esc"
            tamano="sm"
            posicion={side === "right" ? "arriba-izquierda" : side === "bottom" ? "interior" : "arriba-derecha"}
            className="z-20"
          />
