...
export const SETTINGS_SEARCH_INDEX: SettingsSearchEntry[] = [
    ...
    // Abren la ventana directamente en su pestaña, sin salir de donde estés.
    {
        ...
        tab: "ai",
        description: "LLM, Astraura, OmniVoice, cerebro y señales de cada personalidad en este dispositivo.",
        icon: Bot,
        category: "Aurora e IA",
    ...
    },
    {
        ...
        label: "OmniVoice: motor de voz por personalidad",
        keywords: ["motor de voz", "openvoice", "voz por personalidad", "tts", "sintesis", "kokoro", "bark", "clonar voz", "omnivoice"],
        tab: "ai",
        description: "Qué motor usa OmniVoice para cada personalidad en esta neurona (OpenVoice 2 y compañía).",
        icon: Mic,
        category: "Aurora e IA",
