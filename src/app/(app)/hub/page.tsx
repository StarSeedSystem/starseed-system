    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold font-headline text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Hub de Conexiones</h1>
                ...
                <div className="relative w-full md:w-96">
                    ...
                    <Input
                        ...
                        className="pl-9 bg-background/40 backdrop-blur-sm border-primary/20 focus-visible:ring-primary/50"
                    />
                </div>
            </div>
