...
// almacenar en bibliotecas/folders, con vista libre, mapa mental o cerebro,
    ...
    <main className="min-h-screen px-4 py-8 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-sm text-white/50 mt-1 mb-6">
          Centros infinitos que agrupan varias pizarras: guarda, exporta, comparte y almacena en bibliotecas y folders. Míralos como mapa mental o vista cerebro, junto a tus dashboards.
        </p>
