...
export { hasAccountSession, revokeIdentity, currentFingerprint, isRevoked, listRevocationCerts, revokeDeviceByCert, type AccountRevocationCert } from "./server-relay";
