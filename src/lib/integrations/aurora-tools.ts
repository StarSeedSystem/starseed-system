...
export const AURORA_INTEGRATION_TOOLS: AuroraIntegrationTool[] = [
  ...
  // ── qm — memoria vectorial local cuantizada (1.58-bit embeddings, 100% local) ──
  {
    name: "qm_initialize",
    description: "Inicializa la base de datos vectorial local (colecciones, dimensiones, cuantización). Entrada: { collections: [{ name, dimensions, quantization? }] }.",
    integrationId: "qm",
    actionId: "initialize",
    category: "memory",
  },
  {
    name: "qm_upsert",
    description: "Inserta/actualiza vectores con cuantización automática. Entrada: { collection, vectors: [{ id, embedding, metadata? }, ...] }.",
    integrationId: "qm",
    actionId: "upsert",
    category: "memory",
  },
  {
    name: "qm_search",
    description: "Búsqueda k-NN de vectores similares. Entrada: { collection, queryEmbedding, k?, filter? }.",
    integrationId: "qm",
    actionId: "search",
    category: "memory",
  },
  {
    name: "qm_remove",
    description: "Elimina vectores por IDs. Entrada: { collection, ids: [...] }.",
    integrationId: "qm",
    actionId: "remove",
    category: "memory",
  },
  {
    name: "qm_list_collections",
    description: "Lista todas las colecciones con count, dimensions, quantization. Sin entrada.",
    integrationId: "qm",
    actionId: "listCollections",
    category: "memory",
  },
  {
    name: "qm_collection_stats",
    description: "Estadísticas de una colección concreta. Entrada: { collection }.",
    integrationId: "qm",
    actionId: "collectionStats",
    category: "memory",
  },
  {
    name: "qm_embed_local",
    description: "Genera embeddings binarios 1.58-bit locales con Transformers.js. Entrada: { texts: [...] }.",
    integrationId: "qm",
    actionId: "embedLocal",
    category: "memory",
  },
  {
    name: "qm_export_db",
    description: "Exporta la base de datos completa a Uint8Array (backup/sync entre neuronas). Sin entrada.",
    integrationId: "qm",
    actionId: "exportDb",
    category: "memory",
  },
  {
    name: "qm_import_db",
    description: "Importa base de datos desde Uint8Array (restaura/sync). Entrada: { data: Uint8Array|ArrayBuffer }.",
    integrationId: "qm",
    actionId: "importDb",
    category: "memory",
  },
