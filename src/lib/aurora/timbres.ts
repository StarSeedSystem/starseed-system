...
export const TIMBRES: Timbre[] = [
    ...
    // (Ola 222) instruct SOLO con tokens de VALID_INSTRUCT_TOKENS del daemon (género/edad/tono); texto libre en español era rechazado por sanitizeInstruct y todos los timbres caían al default.
