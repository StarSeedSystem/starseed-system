...
export const TIMBRES: Timbre[] = [
    ...
    // (Ola 222) Sin ref: la ruta /Users/alex/... es de una máquina concreta y no existe en otros equipos.
    { id: "fem-aurora", nombre: "Aurora", genero: "femenina", desc: "Cálida, cercana y natural", local: { voz: "ef_dora", speed: 1.0, instruct: "cálida, cercana y serena, como quien acompaña" }, sistema: { bases: ["Paulina", "Mónica", "Monica"], pitch: 1.0, rate: 0.94 }, expr: { arco: 0.16, vivacidad: 0.1, calidez: 0.14 } },
    { id: "fem-luna", nombre: "Luna", genero: "femenina", desc: "Luminosa y expresiva", local: { voz: "ef_dora", speed: 1.14, instruct: "luminosa, alegre y expresiva" }, sistema: { bases: ["Paulina", "Mónica", "Monica"], pitch: 1.16, rate: 1.08 }, expr: { arco: 0.22, vivacidad: 0.2, calidez: 0.1 } },
    { id: "fem-vega", nombre: "Vega", genero: "femenina", desc: "Profunda y envolvente", local: { voz: "ef_dora", speed: 0.86, instruct: "grave, envolvente y pausada" }, sistema: { bases: ["Mónica", "Monica", "Paulina"], pitch: 0.86, rate: 0.86 }, expr: { arco: 0.1, vivacidad: 0.05, calidez: 0.06 } },
    { id: "fem-iris", nombre: "Iris", genero: "femenina", desc: "Ágil, viva y despierta", local: { voz: "ef_dora", speed: 1.28, instruct: "ágil, vivaz y despierta" }, sistema: { bases: ["Paulina", "Mónica", "Monica"], pitch: 1.08, rate: 1.22 }, expr: { arco: 0.26, vivacidad: 0.28, calidez: 0.12 } },
