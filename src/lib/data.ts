...
export const feedItems = [
    {
        ...
        handle: '@alex',
        content: 'Just used the new AI App Generator to build a quick inventory tracker for my side project. Took literally 5 minutes. This is a game-changer for rapid prototyping! 🚀 #StarSeedNetwork #AI',
        timestamp: '2h ago',
        likes: 125,
        comments: 12,
    ...
    },
    {
        ...
        avatar: 'https://placehold.co/100x100.png',
        handle: '@stardust',
        content: 'Announcing Project Constellation: Our next-gen data visualization suite. We\'re leveraging StarSeed Network\'s core to create interactive, real-time dashboards. More details coming soon!',
        timestamp: '3d ago',
        likes: 1200,
        comments: 156,
