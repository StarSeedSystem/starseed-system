...
const OSS_LIBRARY_EXT: OssOption[] = [
  ...
  { id: "red-mesh", name: "Red Mesh", category: "app-platform", description: "Centro soberano de la malla P2P: neuronas, enlaces LoRa y transporte local compartido.", license: "StarSeed Core", url: "/red-mesh", oss: true, maintained: true, defaultIntegrated: true, tags: ["app", "red-mesh", "lora", "p2p", "RadioTower"] },
  { id: "senales", name: "Señales", category: "app-platform", description: "Radar de antenas, nodos e inferencia de borde disponible en esta neurona y su flota.", license: "StarSeed Core", url: "/senales", oss: true, maintained: true, defaultIntegrated: true, tags: ["app", "señales", "antenas", "mesh", "Antenna"] },

  // Capacidad local compartida por la Red Mesh: texto, transporte y Voz StarSeed.
  { id: "inferencia-distribuida-local", name: "Inferencia distribuida local", category: "runtime", description: "Comparte modelos de texto por PAIR/buildwithparallel y voz de borde Supertonic 1.58 entre nodos de la flota, sin GPU ni pago por demanda.", license: "Código abierto", url: "/senales", oss: true, maintained: true, defaultIntegrated: true, tags: ["capacidad", "inferencia-local", "pair", "buildwithparallel", "voz-starseed", "supertonic", "1.58-bit", "sin-gpu"] },
  ...
  { id: "omnifrecuencias", name: "Omnifrecuencias", category: "creation", description: "Estudio de frecuencias funcionales del ecosistema StarSeed: multi-tono, binaural e isocrónico con presets en tu biblioteca, sintetizado EN el navegador (Web Audio, sin servidores). NATIVO del OS en /omnifrecuencias y como widget del Dashboard. REPO OFICIAL (Adenda 97): el código fuente y sus medios viven ahora en el repositorio propio del visionario — github.com/alexbordongarrigos/omnifrecuencias — que es la fuente de verdad para versiones, presets e imágenes de la app en la Biblioteca.", license: "Repo del propio usuario (alexbordongarrigos)", url: "https://github.com/alexbordongarrigos/omnifrecuencias", oss: true, maintained: true, defaultIntegrated: true, tags: ["frecuencias", "binaural", "isocronico", "audio", "nativo", "starseed"] },
